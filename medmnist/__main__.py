...
def download(root='/netscratch/pkhan/datasets/'):
...
def clean(root='/netscratch/pkhan/datasets/'):
...
def save(flag, folder, postfix="png", root='/netscratch/pkhan/datasets/'):
...
def test(save_folder="tmp/", root='/netscratch/pkhan/datasets/'):
